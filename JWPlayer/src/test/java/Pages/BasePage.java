...
public class BasePage {
    ...
    public void goToUrl(String url) {
        ...
        getCurrentDriver().get(url+"?force_cache="+x);
    }
...
// Continue with original browser (first window)
    ...
    public void userLogin(String email, String pword) {
        ...
        writetoField(userName, email);
        writetoField(password, pword);
        click(signInButton);
    }
    ...
    public long currentSystemTime(String action) {
        long currTime = System.currentTimeMillis();
        long currTimeInSecs = TimeUnit.MILLISECONDS.toSeconds(currTime);
        System.out.println(action + "  time now is   ******   " + currTimeInSecs + "  Seconds ");
